          ...
          <div className="footerpromos">
            <div className="instagram">
              ...
              <div className="instagramcontent">
                {/* LightWidget WIDGET */}
                <iframe title="LightWidget" src="https://cdn.lightwidget.com/widgets/0085a09862ad57b9820c0d53e69afb2c.html" scrolling="no" allowTransparency="true" className="lightwidget-widget" style={{width: '100%', border: 0, overflow: 'hidden'}} />
              </div>
            </div>
